...
<script src="/sleepover/js/jquery-1.7.2.min.js"></script>
<script src="/sleepover/js/excanvas.min.js"></script>
<script src="/sleepover/js/chart.min.js" type="text/javascript"></script>
<script src="/sleepover/js/bootstrap.js"></script>
<script language="javascript" type="text/javascript" src="/sleepover/js/full-calendar/fullcalendar.min.js"></script>
 
<script src="/sleepover/js/base.js"></script>

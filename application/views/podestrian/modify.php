	...
	<div class="content clearfix">
		...
		<form action="/sleepover/podestrian/modify" method="post">
			...
			<div class="login-actions">
                <? if($podestrian_id != null) {?>
                    <?="<a href=\"/sleepover/podestrian/delete/$podestrian->podestrian_id\" onclick=\"return confirm('Are you sure ?')\" class=\"button btn btn-danger btn-large pull-left\">Delete</i></a></td>" ?>
                <? ;} ?>
